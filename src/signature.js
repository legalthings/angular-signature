...
angular.module('signature').directive('signaturePad', ['$window', '$timeout',
  function ($window, $timeout) {
    ...
    return {
      restrict: 'EA',
      replace: true,
      template: '<div class="signature" ng-style="{height: height + \'px\', width: width + \'px\'}"><canvas ng-style="{height: height + \'px\', width: width + \'px\'}" ng-mouseup="updateModel()"></canvas></div>',
      scope: {
        accept: '=',
        clear: '=',
        dataurl: '=',
